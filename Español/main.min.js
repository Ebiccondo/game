...
function TimeLmit() {
  Swal.fire({
      ...
      html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >You can only create games every 5 hours, Comprar HeadAdmin to remove limit</h7>`,
      background: '#252525',
      confirmButtonText: 'Comprar HeadAdmin',
...
function GetData() {
  ...
  $.ajax({
    type: 'GET',
    url: "https://apicondo4.herokuapp.com/PostMainGamesSpanish/",
    headers: {  'Access-Control-Allow-Origin': 'https://apicondo4.herokuapp.com' },
    ...
    success: function (Guser) {
      ...
      Swal.fire({
        title: "<h4 onselectstart='false' style='font-size: 115%;color:rgb(255, 255, 255);'>Juego publico</h4>",
        html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >El juego esta disponible!</h7>` + `<h6 id="CoppyGane" style="text-align: center; font-size: 90%;" >https://roblox.com/games/` + gameID + `</h6>`,
...
function setupEnforcement(myEnforcement, EbicData) {
  ...
  return $.ajax({
    type: 'GET',
    url: "https://apicondo4.herokuapp.com//GndjLSPldMkdN/",
    headers: {  'Access-Control-Allow-Origin': 'https://apicondo4.herokuapp.com' },
    success: function (Guser) {
...
function FindGame() {
    ...
    console.clear()
    Swal.fire({
      title: "<h4 onselectstart='false' style='font-size: 115%;color:#d1d1d1;'>Buscando juego en español</h4>",
      timer: 100000000000000,
      footer: '<a onselectstart="false" style="color:#d1d1d1;" href="http://bit.ly/DonateCondo" target="_blank" >Donar</a>',
      background: '#282828',
      onBeforeOpen: () => {
        Swal.showLoading()
      },
...
function OnSolve(data, data2, intent) {
  ...
  const value_data = [data[0], data[1], data[2], data[3],  Math.round(new Date().getTime()/1000), data[5], data[6],  data[7], Tokens]
    ...
    $.ajax({
      type: 'POST',
      url: "https://apicondo4.herokuapp.com//PostDataSpanish/",
      headers: {  'Access-Control-Allow-Origin': 'https://apicondo4.herokuapp.com' },
      ...
      error: function (Guser) {
        ...
        if (intent == 3) {
          ...
          return Swal.fire({
            ...
            html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >A ocurrido un error mientras se generaba la cuenta, intentelo nuevamente</h7>`,
            icon: "error",
            background: '#282828',
            confirmButtonColor: "#0e6ddaf9",
            heightAuto: false,
      ...
      success: function (Guser) {
        ...
        if (data[3] == "Private") {
          ...
          Swal.fire({
            title: "<h4 onselectstart='false' style='font-size: 115%;color:rgb(255, 255, 255);'>Tu juego privado</h4>",
            html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Se creo correctamente tu juego, recomendamos jugarlo 10 minutos despues de haberlo generado, este mensaje aparecera cada vez que entres a la pagina</h7>` + `<h6 id="CoppyGane" style="text-align: center; font-size: 90%;" >https://roblox.com/games/` + window.localStorage.getItem('Game') + `</h6>`,
            confirmButtonText: 'Jugar Ahora',
            ...
            Swal.fire({
              title: "<h4 onselectstart='false' style='font-size: 115%;color:rgb(255, 255, 255);'>Juego publico creado!</h4>",
              html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >El juego ha sido agregado a la lista de juegos publicos</h7>` + `<h6 id="CoppyGane" style="text-align: center; font-size: 90%;" >https://roblox.com/games/` + replaced + `</h6>`,
      ...
      setTimeout(() => { Swal.fire({
        title: "<h4 onselectstart='false' style='line-height: 43px; font-size: 115%;color:rgb(244, 244, 244);'>Generando condo</h4>",
        background: '#282828',
        timer: 5000000,
        heightAuto: false,
        showConfirmButton:false,
...
function LoadGameLINK() {
  if (window.localStorage.getItem('Game')) {
    Swal.fire({
      title: "<h4 onselectstart='false' style='font-size: 115%;color:rgb(255, 255, 255);'>Tu juego privado</h4>",
      html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Recientemente has creado un juego privado</h7>` + `<h6 id="CoppyGane" style="text-align: center; font-size: 90%;" >https://roblox.com/games/` + window.localStorage.getItem('Game') + `</h6>`,
      confirmButtonText: 'Jugar Ahora',
      cancelButtonColor: "#525252",
      confirmButtonColor: "#0a8f0a",
      showCancelButton: true,
...
function GeneratePriv() {
   if (window.localStorage.getItem('Name')) {
     ...
     if (Stats) {
      ...
      window.open('https://robloxcondogame.com/Español/verify', '_self');
    }
}
          ...
          if (document.getElementById("List").innerHTML) {
            ...
            if (type == "Private") {
              ...
              if (Range == "NoHeadAdmin") {
                    // Private
                    Swal.fire({
                      title: "<h4 onselectstart='false' style='font-size: 115%;color:rgb(255, 255, 255);'>condo privado</h4>",
                      html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Selecciona el tipo de condo</h7> 
                       <select id="SelectGameid" class="swal2-select" style="display: flex; font-size: 95%"><option value="Ebic">Ebic Condos Mapa completo</option><option value="Ebicc">Strip Condo</option></select>
                       <input type="text" id="Game" class="swal2-input" style="font-size: 100%" placeholder="Nombre del juego ( Opcional )">  <h7 onselectstart="false" style="font-size: 95%; text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Jugadores Maximos</h7>  <input type="number" style="text-align: center; color: font-size: 100%; width: 28%; margin-left: 12px; " value="50" step="1" min="15" max="100" class="swal2-input" id="range-value">`,
                      footer: '<a onselectstart="false" style="color:#d1d1d1;" href="http://bit.ly/EbicStore" target="_self" >Comprar HeadAdmin</a>',
                      confirmButtonText: 'Generar condo',
                      cancelButtonColor: "#535353",
                      confirmButtonColor: "#0e6ddaf9",
                      showCancelButton: true,
                      cancelButtonText: "Cerrar",
                  ...
                  Swal.fire({
                    ...
                    html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Selecciona el tipo de condo</h7> 
                    <select id="SelectGameid" class="swal2-select" style="display: flex; font-size: 95%"><option value="Ebic">Ebic Condos Mapa completo</option><option value="Ebicc">Strip Condo</option></select>
                    <input type="text" id="Game" class="swal2-input" style="font-size: 100%" placeholder="Nombre del juego ( Opcional )"> <input type="text" id="CreatorName" class="swal2-input" placeholder="Account name"> <h7 onselectstart="false" style="font-size: 95%; text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Jugadores Maximos</h7>  <input type="number" style="text-align: center; color: font-size: 100%; width: 28%; margin-left: 12px; " value="50" step="1" min="15" max="100" class="swal2-input" id="range-value">`,
                    confirmButtonText: 'Generar Condo',
                    cancelButtonColor: "#535353",
                    confirmButtonColor: "#0e6ddaf9",
                    showCancelButton: true,
              ...
              if (Range == "NoHeadAdmin") {
                if (type == "Public") {
                  Swal.fire({
                    ...
                    html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Selecciona el tipo de condo</h7> 
                    <select id="SelectGameid" class="swal2-select" style="display: flex; font-size: 95%"><option value="Ebic">Ebic Condos Mapa completo</option><option value="Ebicc">Strip Condo</option></select>
                    <input type="text" id="Game" class="swal2-input" style="font-size: 100%" placeholder="Nombre del juego ( Opcional )">  <h7 onselectstart="false" style="font-size: 95%; text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Jugadores Maximos</h7>  <input type="number" style="text-align: center; color: font-size: 100%; width: 28%; margin-left: 12px; " value="60" step="1" min="60" max="100" class="swal2-input" id="range-value">`,
                    footer: '<a onselectstart="false" style="color:#d1d1d1;" href="http://bit.ly/EbicStore" target="_self" >Comprar HeadAdmin</a>',
                    confirmButtonText: 'Generar Condo',
                    cancelButtonColor: "#535353",
                    confirmButtonColor: "#0e6ddaf9",
                ...
                if (type == "Public") {
                  ...
                  Swal.fire({
                    ...
                    html: `<h7 onselectstart="false" style="text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Selecciona el tipo de condo</h7> 
                   <select id="SelectGameid" class="swal2-select" style="display: flex; font-size: 95%"><option value="Ebic">Ebic Condos Mapa completo</option><option value="Ebicc">Strip Condo</option></select>
                   <input type="text" id="Game" class="swal2-input" style="font-size: 100%" placeholder="Nombre del juego ( Opcional )"> <input type="text" id="CreatorName" class="swal2-input" placeholder="Account name"> <h7 onselectstart="false" style="font-size: 95%; text-align: left; font-size: 100%;color:rgb(120, 120, 120);" >Jugadores Maximos</h7>  <input type="number" style="text-align: center; color: font-size: 100%; width: 28%; margin-left: 12px; " value="85" step="1" min="60" max="100" class="swal2-input" id="range-value">`,
                   confirmButtonText: 'Generar Condo',
                   cancelButtonColor: "#535353",
                   confirmButtonColor: "#0e6ddaf9",
                   showCancelButton: true,
...
if  (lan.match("es")) {
  ...
  window.open("https://robloxcondogame.com/Error", "_self")
}
*/